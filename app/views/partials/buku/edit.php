                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_kategori"  value="<?php  echo $data['id_kategori']; ?>" type="number" placeholder="Enter Id Kategori" step="1"  required="" name="id_kategori"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-pengarang"  value="<?php  echo $data['pengarang']; ?>" type="text" placeholder="Enter Pengarang"  required="" name="pengarang"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-penerbit"  value="<?php  echo $data['penerbit']; ?>" type="text" placeholder="Enter Penerbit"  required="" name="penerbit"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-tahun_terbit"  value="<?php  echo $data['tahun_terbit']; ?>" type="text" placeholder="Enter Tahun Terbit"  required="" name="tahun_terbit"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
