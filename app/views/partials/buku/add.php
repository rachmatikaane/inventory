...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Buku</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_kategori"  value="<?php  echo $this->set_field_value('id_kategori',""); ?>" type="number" placeholder="Enter Id Kategori" step="1"  required="" name="id_kategori"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-pengarang"  value="<?php  echo $this->set_field_value('pengarang',""); ?>" type="text" placeholder="Enter Pengarang"  required="" name="pengarang"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-penerbit"  value="<?php  echo $this->set_field_value('penerbit',""); ?>" type="text" placeholder="Enter Penerbit"  required="" name="penerbit"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="tahun_terbit">Tahun Terbit <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-tahun_terbit"  value="<?php  echo $this->set_field_value('tahun_terbit',""); ?>" type="text" placeholder="Enter Tahun Terbit"  required="" name="tahun_terbit"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
